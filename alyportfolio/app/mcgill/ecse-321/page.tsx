...
export default function Ecse321() {
  ...
  return (
    ...
    >
      ...
      >
        <p>
          Working in an Agile team, we developed a complete multi-tier
          application. The stack included Spring Boot for the backend, Vue/React
          for the frontend, and rigorous automated testing pipelines.
        </p>
      </motion.div>
    </motion.div>
  );

  ...
  return (
    ...
    >
      <div className="flex flex-col mb-12">
        ...
        <div className="flex flex-wrap gap-2 text-xs font-mono mt-1 text-zinc-500">
          {["Python", "Lego EV3", "Technical Documentation"].map(
            (tag) => (
              <span
                key={tag}
      ...
      >
        <p>
          In this course, we designed and programmed autonomous EV3 robots to
          navigate obstacles, localize themselves using sensors, and complete
          specific physical tasks within a strict time limit.
        </p>
      </motion.div>
    </motion.div>
  );
